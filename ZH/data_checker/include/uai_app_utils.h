...
///  \{
//////////////////////////////////////////////////////////////////////////
#ifndef UAI_APP_UTILS_H_
#define UAI_APP_UTILS_H_
...
public:
    ...
    //ulAvailableSpace MB
    //dUsage 0~1
    static int GetDiskSpace(const std::string& sDisk, unsigned long* ulTotalSpace, unsigned long* ulAvailableSpace, double* dUsage);

};

END_NAMESPACE;

#endif  //UAI_APP_UTILS_H_
