# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-08-31 02:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pixelspacing', models.CharField(blank=True, max_length=33, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patientname', models.CharField(blank=True, max_length=64, null=True)),
                ('patientbirthdate', models.DateField(blank=True, null=True)),
                ('patientsex', models.CharField(blank=True, max_length=16, null=True)),
                ('patientsize', models.CharField(blank=True, max_length=16, null=True)),
                ('patientweight', models.CharField(blank=True, max_length=16, null=True)),
                ('patientcomments', models.CharField(blank=True, max_length=1024, null=True)),
                ('importdatetime', models.DateTimeField(blank=True, null=True)),
                ('updatetime', models.DateTimeField()),
            ],
            options={
                'db_table': 'patient',
