...
class SwigSharedCharArrayUtil(_object):
    ...
    if _newclass:
        CopyToSharedArray = staticmethod(_McsfNetBase.SwigSharedCharArrayUtil_CopyToSharedArray)
    else:
        CopyToSharedArray = _McsfNetBase.SwigSharedCharArrayUtil_CopyToSharedArray
...
def SwigSharedCharArrayUtil_CopyToSharedArray(strArray):
    return _McsfNetBase.SwigSharedCharArrayUtil_CopyToSharedArray(strArray)
SwigSharedCharArrayUtil_CopyToSharedArray = _McsfNetBase.SwigSharedCharArrayUtil_CopyToSharedArray
